...
void main() {
	...
	v_TexCoordClouds.xy = (in_TextureCoord + g_Time * g_CloudSpeeds.x) * g_CloudScales.xy;
	v_TexCoordClouds.zw = (in_TextureCoord + g_Time * g_CloudSpeeds.y) * g_CloudScales.zw;
